...
namespace STG
{
    class Traversing
    {
        ...
        private static void Traverse(IGenericObject genericObject, IApp app)
        {
            ...
            Table table = genericObject as Table;
            TableHyperCubeDef hCube = table.Properties.HyperCubeDef;
            //hCube.
            //GetTableData()
        }

        private static void GetTableData(IGenericObject genericObject, IApp app) {
